      ...
      <section className="contact container section" id='contact' >
        ...
        <div className="contact__container grid">
          <div className="contact__info">
            ...
            <p className="contact__details">Don't like forms? Send me an email at haseeb@haseebworks.com👋 </p>
          </div>

          <form  onSubmit={onSubmit} method="POST" className="contact__form">
          <input type="hidden" name="access_key" value="a158da79-635e-4841-b110-7aa231fcf9dd" />
            ...
            <div className="contact__form-group">
              ...
              <div className="contact__form-div">
                <input type="text" className="contact__form-input" 
                placeholder='Insert your subject' name="subject" />
